  ...
  <div>
    ...
    <template v-else>
      ...
      <table class="table is-striped is-fullwidth">
        <thead>
          <th style="width:200px;" class="has-text-right">Nombres</th>
          <th style="width:200px;" class="has-text-right">Apellidos</th>
          <th style="width:200px;" class="has-text-right">DNI</th>
          <th style="width:200px;" class="has-text-right">Grado academico</th>
